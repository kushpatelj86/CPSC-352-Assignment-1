...
ENCRYPTION_KEY = argv[3] #arg 3 is encryption key
...
paddedMsg = pad(msg, 16) 	# Pads the text to be a multiple of 16 bytes
encCipher = AES.new(ENCRYPTION_KEY, AES.MODE_ECB)
cipherText = encCipher.encrypt(paddedMsg.encode())
